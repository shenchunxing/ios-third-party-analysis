...
- (id)init {
    ...
    self.shortLabel.backgroundColor = [UIColor orangeColor];
    ...
    self.longLabel.backgroundColor = [UIColor yellowColor];
...
- (void)layoutSubviews {
    ...
    #pragma mark - 多行布局需要使用的preferredMaxLayoutWidth，限制最大宽度
